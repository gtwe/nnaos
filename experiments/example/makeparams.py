...
from aos.loss import KernelLoss


class Experiment:
    def __init__(self):
        self.expname = "example"
        self.nets = [
            {
                "name": "wide_shallow",
                "module": FullyConnected,
                "module_args": {
                    "width": Product([_ for _ in range(32, 65, 16)], group="dof"),
                    "depth": 2,
        ...
        self.common = {
            "train_dataset": KernelDataCubeRandom,
            "train_dataset_args": {
                "n_samples": Product(
                    [_ for _ in range(50, 251, 50)], group="n_samples"
                ),
            ...
            "epochs": Product([100], group="epochs"),
            "dim": Product([3], group="dim"),
            "repetition": Product(list(range(2)), group="repeat"),
